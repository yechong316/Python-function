...
def get_encoder_layer(input_data, rnn_size, num_layers,
    ...
    # RNN cell
    def get_lstm_cell(rnn_size):return tf.contrib.rnn.LSTMCell(rnn_size, initializer=tf.random_uniform_initializer(-0.1, 0.1, seed=2))
